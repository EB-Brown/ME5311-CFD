...
theta_na = temperature_boundaries(theta_na, x_num, y_num, ghost, left_temp);
...
theta_nb = temperature_boundaries(theta_nb, x_num, y_num, ghost, left_temp);
...
theta = temperature_boundaries(theta, x_num, y_num, ghost, left_temp);
