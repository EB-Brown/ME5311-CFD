...
for n=1:iterations
    ...
    [u_velocity, v_velocity, temperature, h_flux, t] = simulate( ...
        u_velocity, v_velocity, temperature, dx, dy, ...
        0, cfl_target, current_time, chunk_end_time, ...
        prandtl, rayleigh, ...
    ...
    % Store arrays for heat_flux plot
    time = [time; t];
    heat_flux.left = [heat_flux.left; h_flux.left];
    heat_flux.right = [heat_flux.right; h_flux.right];
